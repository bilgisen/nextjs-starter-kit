    ...
    >
      ...
      <div className="flex-1 space-y-4">
        ...
        <div className="flex flex-col md:flex-row gap-4">
          <div className="flex-1">
            ...
            <input
              type="text"
              {...register("author")}
              className="w-full border px-3 py-2 rounded text-muted-foreground/50 text-sm"
            />
          ...
          <div className="flex-1">
            ...
            <input
              type="text"
              {...register("publisher")}
              className="w-full border px-3 py-2 rounded text-muted text-sm"
            />
        ...
        <div className="flex flex-col md:flex-row gap-12">
          <div className="flex-1">
            <label className="block text-sm font-medium text-muted mb-1">ISBN</label>
            <input
              type="text"
              {...register("isbn")}
              className="w-full border px-3 py-2 rounded text-muted-foreground/50 text-sm"
          ...
          <div className="flex-1">
            ...
            <input
              ...
              className="w-full border px-3 py-2 rounded text-muted-foreground/50 text-sm"
            />
            {errors.publish_year && <p className="text-red-500 text-sm">{errors.publish_year.message}</p>}
          </div>
          <div className="flex-1">
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full border px-3 py-2 rounded text-sm min-h-[100px]"
          />
        </div>
